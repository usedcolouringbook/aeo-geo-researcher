...
Plain-language definitions for the research domain. Specialists use this vocabulary consistently. When a client uses a term differently, specialists note the discrepancy rather than silently adopting the client's usage.

> **Canonical copy:** `docs/reference/glossary.md` (published to the docs site). Add new terms there; this file mirrors the content for agent-side access.
