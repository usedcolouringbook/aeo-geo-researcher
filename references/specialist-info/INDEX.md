...
**Session workflow:** `references/procedures/` — three-step pipeline: `01-scan.md` (surface sweep) → `02-investigate.md` (specialist deep dive) → `03-source-audit.md` (adversarial review). See `Specialists/0-orchestrator/rules.md` for when to use each step.
